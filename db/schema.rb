...
ActiveRecord::Schema.define(version: 2019_03_05_062319) do
  ...
  create_table "expired_foods", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.datetime "created_at", null: false
  ...
  create_table "foods", force: :cascade do |t|
    ...
    t.integer "quantity"
    t.integer "health_scale"
    t.boolean "is_it_expired", default: false
  end
